...
const WORKFLOW_TEMPLATES: WorkflowTemplate[] = [
  ...
  },
  {
    id: "time-off-request",
    name: "Leave Request",
    description: "Standard vacation, sick leave, or personal time off approval process",
    category: "HR",
    organizationType: "All",
    steps: 3,
    estimatedTime: "2-4 hours",
    popularity: 98,
    tags: ["hr", "vacation", "leave", "pto"],
    preview: {
      steps: [
        { name: "Submit Request", type: "start", icon: FileText },
        { name: "Manager Approval", type: "approval", icon: Users },
        { name: "HR Verification", type: "approval", icon: Building2 },
        { name: "Complete", type: "end", icon: Clock },
      ],
    },
  },
  {
    ...
    description: "Request for access to sensitive financial records or historical audit logs",
    category: "Finance",
    organizationType: "All",
    steps: 4,
    estimatedTime: "1-2 days",
    popularity: 82,
    tags: ["finance", "audit", "compliance", "security"],
    preview: {
      steps: [
        { name: "Access Request", type: "start", icon: FileText },
        { name: "Compliance Review", type: "approval", icon: Landmark },
        { name: "CFO Approval", type: "approval", icon: DollarSign },
        { name: "IT Grant Access", type: "approval", icon: Building2 },
        { name: "Complete", type: "end", icon: Clock },
      ],
    },
  },
  {
    ...
    description: "Request for new hardware, office supplies, or specialized equipment",
    category: "Operations",
    organizationType: "All",
    steps: 3,
    estimatedTime: "3-5 days",
    popularity: 89,
    tags: ["operations", "equipment", "inventory", "hardware"],
    preview: {
      steps: [
        { name: "Gear Request", type: "start", icon: FileText },
        { name: "Manager Approval", type: "approval", icon: Users },
        { name: "Procurement", type: "approval", icon: Briefcase },
        { name: "Complete", type: "end", icon: Clock },
      ],
    },
  },
  {
    ...
    description: "Annual or quarterly employee performance review and feedback cycle",
    category: "HR",
    organizationType: "Enterprise",
    steps: 5,
    estimatedTime: "2 weeks",
    popularity: 75,
    tags: ["hr", "performance", "review", "feedback"],
    preview: {
      steps: [
        { name: "Self Assessment", type: "start", icon: FileText },
        { name: "Manager Review", type: "approval", icon: Users },
        { name: "Skip Level Review", type: "approval", icon: Users },
        { name: "HR Calibration", type: "approval", icon: Building2 },
        { name: "Employee Acknowledgment", type: "approval", icon: Clock },
      ],
    },
  },
  {
