            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                <Card className="border-none shadow-xl shadow-slate-200/50 bg-white">
                    ...
                    <CardContent>
                        ...
                        <p className="text-xs text-orange-600 font-bold mt-1">Value: $28,400</p>
                    </CardContent>
                </Card>
                ...
                <Card className="border-none shadow-xl shadow-slate-200/50 bg-white">
                    ...
                    <CardContent>
                        ...
                        <p className="text-xs text-blue-600 font-bold mt-1">3 awaiting compliance check</p>
                    </CardContent>
                </Card>
                ...
                <Card className="border-none shadow-xl shadow-slate-200/50 bg-white">
                    ...
                    <CardContent>
                        ...
                        <p className="text-xs text-emerald-600 font-bold mt-1">Total spend: $142,500</p>
                    </CardContent>
                </Card>

                <Card className="border-none shadow-xl shadow-slate-200/50 bg-slate-900 text-white">
                    <CardHeader className="flex flex-row items-center justify-between pb-2">
                        <CardTitle className="text-sm font-bold uppercase opacity-80">Cycle Time</CardTitle>
                        <Clock className="h-4 w-4 text-white" />
                    </CardHeader>
                    <CardContent>
                        <div className="text-3xl font-extrabold">2.4d</div>
                        <p className="text-xs font-bold mt-1 text-slate-400">Target: 2.0 days</p>
                    </CardContent>
                </Card>
            </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
                ...
                <Card className="border-none shadow-2xl shadow-slate-200/40">
                    <CardHeader className="flex flex-row items-center justify-between">
                        ...
                        <Button size="sm" className="bg-blue-600 font-bold text-xs h-8">Add Vendor</Button>
                    </CardHeader>
                        ...
                        {[
                            ...
                            <div key={idx} className="flex items-center justify-between p-4 border border-slate-100 rounded-xl group hover:bg-slate-50 transition-all">
                                ...
                                <div className="text-right">
                                    ...
                                    <Badge variant="outline" className={`text-[9px] h-4 px-1 ${vendor.status === 'Active' ? 'bg-emerald-50 text-emerald-700 border-emerald-100' : 'bg-orange-50 text-orange-700 border-orange-100'}`}>
                                        {vendor.status}
                                    </Badge>
                                </div>
                            </div>
                ...
                <div className="space-y-6">
                    <Card className="border-none shadow-2xl shadow-slate-200/40 bg-white">
                        ...
                        <CardContent className="space-y-5">
                            {[
                                { name: "CloudScale", value: 65, color: "bg-blue-600" },
                                { name: "Global Log", value: 20, color: "bg-indigo-600" },
                                { name: "Others", value: 15, color: "bg-slate-400" },
                            ].map((item) => (
                    ...
                    <Card className="border-none shadow-2xl shadow-slate-200/40 bg-gradient-to-br from-orange-500 to-rose-600 text-white overflow-hidden relative">
                        ...
                        <CardContent>
                            ...
                            <Button className="w-full bg-white text-orange-700 hover:bg-slate-100 h-9 font-bold text-xs rounded-xl shadow-lg">
                                Generate PO #8442
                            </Button>
                        </CardContent>
                    </Card>
